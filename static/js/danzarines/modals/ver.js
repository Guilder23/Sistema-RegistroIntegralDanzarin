document.addEventListener('DOMContentLoaded', function () {
    const modalVer = document.getElementById('modalVerDanzarin');
    if (!modalVer) return;
    ...
    modalVer.addEventListener('show.bs.modal', function (event) {
        ...
        setText('verCodigoDanzarin', button.getAttribute('data-codigo-danzarin') || '');
    ...
    document.querySelectorAll('.btn-ver-danzarin').forEach(btn => {
